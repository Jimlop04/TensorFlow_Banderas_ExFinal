...
import org.tensorflow.lite.examples.classification.ml.ModeloBanderas
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnFotoBandera = findViewById<Button>(R.id.btn_fotoBandera);
        btnFotoBandera.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View?) {
                Toast.makeText(view!!.context, "Codigo: " + codigos , Toast.LENGTH_LONG).show()
                createActivity(view)
            }
    ...
    fun createActivity(view: View?) {
        val intent = Intent(this, Result_Countrys::class.java).apply {
            putExtra("code", codigos)
        }
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        val model = ModeloBanderas.newInstance(ctx)
